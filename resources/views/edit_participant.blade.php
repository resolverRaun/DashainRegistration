                    ...
                    <div class="panel-body">
                        <form action="{{ url('/home/participants/edit') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="participant_name" value="{{ $participant_info['name'] }}" />
                            </div>
                            <div class="form-group">
                                <label>Select Participant types</label>
                                <select class="form-control" id="participant_type" name="is_member">
                                    <option value="1" <?php if($participant_info['is_member'] == 1){ echo "selected"; } ?> >Member</option>
                                    <option value="0" <?php if($participant_info['is_member'] == 0){ echo "selected"; } ?> >Non Member</option>
                                </select>
                            </div>
                            <?php //var_dump($participant_info);die; ?>
                            <div class="form-group">
                                <label for="participator_adult">Adult</label>
                                <input type="text" class="form-control" name="adult" id="participant_adult" vaule="{{ $participant_info['participant_type']['adult'] }}"/>
                            </div>
                            <div class="form-group">
                                <label for="participator_children">Children</label>
                                <input type="text" class="form-control" name="children" id="participant_children"  vaule="{{ $participant_info['participant_type']['children'] }}" />
                            </div>
                            <div class="form-group">
                                <label for="participator_senior">Senior</label>
                                <input type="text" class="form-control" name="senior" id="participant_senior"  vaule="{{ $participant_info['participant_type']['senior'] }}" />
                            </div>
                            <div class="form-group">
                                <label for="participator_tot_cost">Total Cost</label>
                                <input type="text" class="form-control" name="cost_amt" id="cost_amt"  vaule="{{ $participant_info['cost_amt'] }}" />
                            </div>
                            <div class="form-group">
                                <label for="participator_received_amt">Received Amount</label>
                                <input type="text" class="form-control" name="received_amt" id="received_amt"  vaule="{{ $participant_info['received_amt'] }}" />
                            </div>
                            <div class="form-group">
                                <label for="participator_return_amt">Return Amount</label>
                                <input type="text" class="form-control" name="return_amt" id="return_amt"  vaule="{{ $participant_info['return_amt'] }}" />
                            </div>
                            <div class="form-group">
